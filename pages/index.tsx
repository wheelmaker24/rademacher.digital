...
const HomePage = () => (
  <Layout>
    <h2>Hey, I'm a frontend web developer.</h2>
    <p>
      As a child I was interested in complex traffic infrastructures: airports,
      radial highways and big interjections need to deal with the daily traffic
      and quickly bring each person to their destinations. Today I like to build
      digital junctions.
    </p>
    ...
    <CurriculumVitae>
      ...
      >
        <ul>
          <li>Web development for small and medium-sized enterprises and cities</li>
          <li>IT consulting</li>
        </ul>
      ...
      >
        <ul>
          <li>Developing the e-learning platform „i-Study“ on behalf of the University of Marburg</li>
